package br.com.ais.pontoeletronico.security.jwt

import br.com.ais.pontoeletronico.security.CustomUsernamePasswordAuthenticationToken
...
class TokenProvider(private val jHipsterProperties: JHipsterProperties) {
    ...
    fun getAuthentication(token: String): Authentication {
        ...
        val userId: Long = claims[USER_ID_KEY].let { id -> id.toString().toLong() }

        val principal = User(claims.subject, "", authorities)

        return CustomUsernamePasswordAuthenticationToken(principal, token, authorities, userId)
    }
