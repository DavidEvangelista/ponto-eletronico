...
import br.com.ais.pontoeletronico.config.ApplicationProperties
...
class PontoeletronicoServiceApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes pontoeletronicoService.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<PontoeletronicoServiceApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(PontoeletronicoServiceApp::class.java)
