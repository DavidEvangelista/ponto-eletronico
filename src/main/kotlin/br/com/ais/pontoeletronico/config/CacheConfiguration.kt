...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pontoeletronicoService")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "pontoeletronicoService"
        ...
        config.mapConfigs["br.com.ais.pontoeletronico.domain.*"] = initializeDomainMapConfig(jHipsterProperties)
